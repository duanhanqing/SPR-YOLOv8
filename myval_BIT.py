...
#     model = YOLO(r'/szzn/luoluo/work2/YOLOv8.2/消融实验/UA_Detrac_300/2YOLOv8_SlimNeck/runs/train/exp/weights/best.pt')
#     results = model.val(
#         data=r'/szzn/luoluo/work2/YOLOv8.2/ultralytics/cfg/datasets/BIT_Vehicle.yaml',
#         split='val',
#         imgsz=640,
#         batch=16,
#         workers=8,
#         device='0',
#         project='/szzn/luoluo/work2/YOLOv8.2/消融实验/UA_Detrac_300/2YOLOv8_SlimNeck',
#         name='val_fps',
#     )
...
if __name__ == '__main__':
    try:
        ...
        # 加载模型并执行验证
        model = YOLO(r'/szzn/luoluo/work2/YOLOv8.2/消融实验/UA_Detrac_300/7YOLOv8_SGBackbone_SlimNeck_DetectSA/runs/train/exp/weights/best.pt')
        results = model.val(
            data=r'/szzn/luoluo/work2/YOLOv8.2/ultralytics/cfg/datasets/UA_Detrac.yaml',
            split='val',
            imgsz=640,
            batch=16,
            workers=8,
            device='0',
            project='/szzn/luoluo/work2/YOLOv8.2/消融实验/UA_Detrac_300/7YOLOv8_SGBackbone_SlimNeck_DetectSA',
            name='val_jiankong',
        )
