...
from .Addmodules.SlimNeck import VoVGSCSP,GSConv
...
class BaseModel(nn.Module):
    ...
    def _apply(self, fn):
        ...
        if isinstance(m, (Detect, Detect_AFPN, Detect_AFPN4, Detect_AFPN3, Detect_ASFF, Detect_FRM, Detect_dyhead, CLLAHead,
                          Detect_DySnakeConv, Detect_dyhead3, Detect_DySnakeConv, Segment_DBB, Detect_DBB, Detect_FASFF,
                          RFAHead, RFASegment, RepHead, Detect_Adown, Detect_SA, Segment_SA, HATHead, ADDWConvHead)):  # includes all Detect subclasses like Segment, Pose, OBB, WorldDetect
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
                 BottleneckCSP, C1, C2, C2f, RepNCSPELAN4, ADown, SPPELAN, C2fAttn, C3, C3TR, C3Ghost, ModulatedDeformConv2dPack,
                 nn.ConvTranspose2d,  DWConvTranspose2d, C3x, RepC3, C2f_ACmix, C2f_AKConv, AKConv, C2f_Context, C2f_WTConv,
                 ...
                 C2f_DCNv3, Blocks, ConvNormLayer, C2f_FasterBlock, RepNCSPELAN4_high, SPPELAN, C2f_DCNv3_DLKA, C2f_Dual,
                 RepNCSPELAN4_low, C2f_DynamicConv, DynamicConv, Down_wt, C2f_GhostModule_DynamicConv, C2f_UIB, C2fCIB, 
                 SCDown, PSA, MLLAttention, SCSA, C2fMLLABlock, WavKANConv2d, RBFKANConv2d, KANConv2d, ReLUKANConv2d, 
                 FasterKANConv2d, ChebyKANConv2d, JacobiKANConv2d, FastKANConv2d, GRAMKANConv2d, C2f_BFAM, C2f_DFF):
            ...
            if m in (BottleneckCSP, C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3, C2f_ACmix, C2f_AKConv,
                     ...
                     C2f_MLCA, C2f_ODConv, RCSOSA, CSPStage, C2f_RFAConv, C2f_SAConv, C2f_SCConv, C2f_SENetV1, C2f_WTConv,
                     ...
                     C2f_GhostModule_DynamicConv, C2f_UIB, C2fCIB, C2f_Dual,C2f_Context, C2fMLLABlock, C2f_BFAM, C2f_DFF):
        ...
        #---------------------------------------注意力机制------------------------
                   ...
                   SELayerV1, SELayerV2, HAT, EMA, MLCA, ACmix, CARAFE, DAttentionBaseline, iRMB_EMA, AIFI,
                   ...
                   SPDEMA, AirNet, ADNet, RIDNET, LAE}:
            c2 = ch[f]
            args = [c2, *args]
        ...
        # ------------------------------ASF-YOLO--------------------------------
            ...
            c2 = sum(ch[x] for x in f)
        elif m in {Detect, WorldDetect, Segment, Pose, OBB, ImagePoolingAttn, Detect_AFPN, Detect_AFPN4,  Detect_AFPN3, Detect_ASFF,
                   ...
                   Detect_Adown, Pose_SA, Segment_SA, Detect_SA, HATHead, ADDWConvHead}:
    ...
    if isinstance(model, nn.Module):  # PyTorch model
        ...
        for m in model.modules():
            if isinstance(m, (Segment, Segment_DySnakeConv, Segment_DBB, RFASegment, Segment_SA)):
                ...
                return "obb"
            elif isinstance(m, (Detect, WorldDetect, Detect_AFPN, Detect_AFPN4, Detect_AFPN3, Detect_ASFF, Detect_FRM,
                                Detect_dyhead, CLLAHead, Detect_dyhead3, Detect_DySnakeConv, Detect_DBB, Detect_FASFF,
                                RFAHead, RepHead, Detect_Adown, Detect_SA, HATHead, ADDWConvHead)):
                return "detect"
