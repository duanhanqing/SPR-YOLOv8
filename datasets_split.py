...
if __name__ == '__main__':
    ...
    parser.add_argument('--image-dir', type=str, default=r'/szzn/luoluo/work2/YOLOv8.2/runs_test/BDD_100K/train/images', help='image path dir')
    parser.add_argument('--txt-dir', type=str, default=r'/szzn/luoluo/work2/YOLOv8.2/runs_test/BDD_100K/train/labels', help='txt path dir')
    parser.add_argument('--save-dir', default=r'/szzn/luoluo/work2/YOLOv8.2/datasets/BDD_100K', type=str, help='save dir')
