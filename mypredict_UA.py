...
if __name__ == '__main__':
    model = YOLO(r'/szzn/luoluo/work2/YOLOv8.2/消融实验/UA_Detrac_300/7YOLOv8_SGBackbone_SlimNeck_DetectSA/runs/train/exp/weights/best.pt') # select your model.pt path
    model.predict(source=r'/szzn/luoluo/work2/YOLOv8.2/datasets/UA_Detrac/images/test',
                  # split='test',  # 使用测试集
                  imgsz=640,
                  name='exp',
                  save=True,
                  ...
                  device='7',
                  # classes=0,
                  project= '/szzn/luoluo/work2/YOLOv8.2/消融实验/UA_Detrac_300/7YOLOv8_SGBackbone_SlimNeck_DetectSA/runs/test',
                )
...
#                     device='7',
#                     # classes=0,
#                     project= '/szzn/luoluo/work2/YOLOv8.2/消融实验/UA_Detrac_300/7YOLOv8_SGBackbone_SlimNeck_DetectSA/runs/test_jiankong',
#                     )
#         # 计算总时间
#         end_time = time.time()
